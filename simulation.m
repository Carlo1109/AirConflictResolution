...
ymin = min([pmin(2), pmin(5)])-(r+1);

pmax = max(p);
xmax = max([pmax(1), pmax(4)])+(r+1);
ymax = max([pmax(2), pmax(5)])+(r+1);
...
air1 = rectangle('Position', [x01-r, y01-r, 2*r, 2*r],...
                      ...
                      'LineWidth', 1,...
                      'LineStyle', '-',...
                      'FaceColor', [0.9290 0.6940 0.1250 1],...
                      'Parent', h);
...
vec1 = quiver(x01, y01, x01+r*cos(phi1(1)), y01+r*sin(phi1(1)), 'Color', 'green', 'LineWidth', 2,'MaxHeadSize', 0.5);
vec2 = quiver(x02, y02, x02+r*cos(phi1(1)), y02+r*sin(phi2(1)), 'Color', 'red', 'LineWidth', 2, 'MaxHeadSize', 0.5);
